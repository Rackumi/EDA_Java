...
/**
 * An interface for a tree. Not an specific type of tree
 *
...
public interface Tree<E> extends Iterable<Position<E>> {
     ...
     */
    Iterable<? extends Position<E>> children(Position<E> v) throws RuntimeException;
     ...
     */
    boolean isRoot(Position<E> v) throws RuntimeException;
